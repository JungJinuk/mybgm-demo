...
let bestSellers = [
  { Title: 'City Of Stars', Artist: 'Ryan Gosling', Path: '/data/images/cover/City Of Stars.png', 
    Wave: '/data/images/wave/City Of Stars_wave.png', Price: '1900', Song:'/data/musics/Imagin Dragons-Amsterdam.mp3' },
  ...
  { Title: 'Ai Se Eu Te Pego', Artist: 'Nossa Nossa', Path: '/data/images/cover/Ai Se Eu Te Pego.png', 
    Wave: '/data/images/wave/Ai Se Eu Te Pego_wave.png', Price: '1500', Song:'/data/musics/Imagin Dragons-Amsterdam.mp3' },
];

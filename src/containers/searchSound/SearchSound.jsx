...
let musicDataSamples = [
  ...
  },
  {
    ...
    Music: {
      ...
      Price: 1900,
      Image: '/data/images/cover/Uptown Funk.png',
      Likes: 32,
      Genre: ['월드뮤직'],
      Mood: ['FANTASY'],
      Instrument: ['스트링'],
  ...
  },
  {
    ...
    Music: {
      ...
      Title: 'Civilization',
      Price: 1900,
      Image: '/data/images/cover/Plug In Baby.png',
      Likes: 32,
      Genre: ['월드뮤직'],
      Mood: ['FANTASY'],
      Instrument: ['보이스'],
